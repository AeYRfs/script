...
function initSettings() {
    ...
    const users = JSON.parse(localStorage.getItem("users")) || {};
    const isVip = currentUser && users[currentUser]?.vip || false;
        ...
        <div class="parameters">
            ...
            <div class="settings-buttons">
                ...
                ${currentUser ? `
                    ...
                    <button id="topUpButton">${settingsLanguages[currentLang].topUpAccount}</button>
                    ${isVip ? `<button id="createLevelButton">${settingsLanguages[currentLang].createLevel}</button>` : ""}
    ...
    if (currentUser) {
        ...
        if (isVip) {
            document.getElementById("createLevelButton").addEventListener("click", () => {
                location.href = "createLevel.html";
            });
        }
