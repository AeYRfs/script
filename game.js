...
const standardLevels = {
  ...
  2: [
    ...
    { name: 'SO2', x: 400, y: '#8c564b', shape: 'circle', question: { en: 'What is SO2 called?', ru: 'Как называется SO2?' }, answer: { en: 'sulfur dioxide', ru: 'диоксид серы' }, hint: { en: 'Gas with a pungent smell', ru: 'Газ с резким запахом' } },
  ...
  3: [
    { name: 'OH', x: 100, y: '#ff7f0e', shape: 'circle', question: { en: 'What is OH called?', ru: 'Как называется OH?' }, answer: { en: 'hydroxide', ru: 'гидроксид' }, hint: { en: 'Ion found in bases', ru: 'Ион, содержащийся в основаниях' } },
    ...
    { name: 'Ca', x: 100, y: 300, color: '#9467bd', shape: 'circle', question: { en: 'What is Ca called?', ru: 'Как называется Ca?' }, answer: { en: 'calcium', ru: 'кальций' }, hint: { en: 'Element essential for bones', ru: 'Элемент, необходимый для костей' } },
  ...
  8: [
    ...
    { name: 'ZnO', x: 250, y: 900, color: '#ffock7f0e', shape: 'circle', question: { en: 'What is ZnO called?', ru: 'Как называется ZnO?' }, answer: { en: 'zinc oxide', ru: 'Оксид цинка' }, hint: { en: 'Used in sunscreen', ru: 'Используется в солнцезащитных кремах' } },
  ...
  9: [
    ...
    { name: 'Al2O3', x: 250, y: 150, color: '#8c564b', shape: 'circle', question: { en: 'What is Al2O3 called?', ru: 'Как называется Al2O3?' }, answer: { en: 'aluminium oxide', ru: 'Оксид алюминия' }, hint: { en: 'Compound used in abrasives', ru: 'Соединение, используемое в абразивах' } },
    ...
    { name: 'H2O2', x: 400, y: 300, color: '#ff7f0e', shape: 'circle', question: { en: 'What is H2O2 called?', ru: 'Как называется H2?' }, answer: { en: 'hydrogen peroxide', ru: 'Перекись водорода' }, hint: { en: 'Used as a disinfectant', ru: 'Используется как дезинфицирующее средство' } },
    ...
    { name: 'CaO', x: 400, y: 450, color: '#1f77b4', shape: 'circle', question: { en: 'What is CaO called?', ru: 'Как называется CaO?' }, answer: { en: 'calcium oxide', ru: 'Оксид кальция' }, hint: { en: 'Also known as quicklime', ru: 'Также известен как негашеная известь' } },
   ...
   { name: 'H3PO4', x: 250, y: 600, color: '#8c564b', shape: 'circle', question: { en: 'What is H3PO4 called?', ru: 'Как называется H3PO4?' }, answer: { en: 'phosphoric acid', ru: 'Фосфорная кислота' }, hint: { en: 'Acid used in soft drinks', ru: 'Кислота, используемая в газированных напитках' } },
    ...
    { name: 'FeCl3', x: 100, y: 750, color: '#3f7f7f', shape: 'circle', question: { en: 'What is FeCl3 called?', ru: 'Как называется FeCl3?' }, answer: { en: 'iron(III) chloride', ru: 'Хлорид железа(III)' }, hint: { en: 'Used in water treatment', ru: 'Используется в очистке воды' } },
    ...
    { name: 'H2CO3', x: 400, y: 900, color: '#1f77b4', shape: 'circle', question: { en: 'What is H2CO3 called?', ru: 'Как называется H2CO3?' }, answer: { en: 'carbonic acid', ru: 'Угольная кислота' }, hint: { en: 'Formed when CO2 dissolves in water', ru: 'Образуется при растворении CO2 в воде' } },
  ...
  10: [
    { name: 'HNO3', x: 100, y: 150, color: '#e377c2', shape: 'circle', question: { en: 'What is HNO3 called?', ru: 'Как называется HNO3?' }, answer: { en: 'nitric acid', ru: 'Азотная кислота' }, hint: { en: 'Acid used in fertilizers', ru: 'Кисловая кислота, используемая в удобрениях' } },
    ...
    { name: 'H2O2', x: 100, y: 300, color: '#ff7f0e', shape: 'circle', question: { en: 'What is H2O2 called?', ru: 'Как называется H2?' }, answer: { en: 'hydrogen peroxide', ru: 'Перекись водорода' }, hint: { en: 'Used as a disinfectant', ru: 'Используется как дезинфицирующее средство' } },
    { name: 'N2O', x: 250, y: 300, color: '#d62728', shape: 'circle', question: { en: 'What is N2O called?', ru: 'Как называется N2O?' }, answer: { en: 'nitrous oxide', ru: 'Закись азота' }, hint: { en: 'Gas known as laughing gas', ru: 'ГГаз, известный как весёлый газ' } },
    ...
    { name: 'CaO', x: 100, y: 450, color: '#1f77b4', shape: 'circle', question: { en: 'What is CaO called?', ru: 'Как называется CaO?' }, answer: { en: 'calcium oxide', ru: 'Оксид кальция' }, hint: { en: 'Also known as quicklime', ru: 'Также известен как негашеная известь' } },
    ...
    { name: 'FeCl3', x: 250, y: 600, color: '#4f7f7f', shape: 'circle', question: { en: 'What is FeCl3 called?', ru: 'Как называется FeCl3?' }, answer: { en: 'iron(III) chloride', ru: 'Хлорид железа(III)' }, hint: { en: 'Used in water treatment', ru: 'Используется в очистке воды' } },
    ...
    { name: 'H2CO3', x: 100, y: 900, color: '#1f77b4', shape: 'circle', question: { en: 'What is H2CO3 called?', ru: 'Как называется H2CO3?' }, answer: { en: 'carbonic acid', ru: 'Угольная кислота' }, hint: { en: 'Formed when CO2 dissolves in water', ru: 'Образуется при растворении CO2 в воде' } },
    ...
    { name: 'MgCl2', x: 400, y: 900, color: '#8c564b', shape: 'circle', question: { en: 'What is MgCl2 called?', ru: 'Как называется MgCl2?' }, answer: { en: 'magnesium chloride', ru: 'Хлорид магния' }, hint: { en: 'Used in de-icing roads', ru: 'Используется для удаления льда' } },
    ...
    { name: 'FeSO4', x: 250, y: 1050, color: '#6f7f7f', shape: 'circle', question: { en: 'What is FeSO4 called?', ru: 'Как называется FeSO4?' }, answer: { en: 'iron(II) sulfate', ru: 'Сульфат железа(II)' }, hint: { en: 'Used in iron supplements', ru: 'Используется в добавках железа' } },
    { name: 'CuSO4', x: 400, y: 1050, color: '#2ca02c', shape: 'circle', question: { en: 'What is CuSO4 called?', ru: 'Как называется CuSO4?' }, answer: { en: 'copper(II) sulfate', ru: 'Сульфат меди' }, hint: { en: 'Blue crystals used in agriculture', ru: 'Синие кристаллы, используемые в сельском хозяйстве' } },
    { name: 'ZnSO4', x: 100, y: 1200, color: '#ff7f0e', shape: 'circle', question: { en: 'What is ZnSO4 called?', ru: 'Как называется ZnSO4?' }, answer: { en: 'zinc sulfate', ru: 'Сульфат цинка' }, hint: { en: 'Used in zinc supplements', en: 'Used in zinc supplements' } },
...
class ChemistryGame {
  ...
  init() {
    ...
    this.createUI(); // Moved before loadLevel
    this.loadLevel();
    this.setupModal();
    this.resizeCanvas();
    this.startGameLoop();
  ...
  generateSpacedCoordinates(count, width, height) {
    ...
    for (let i = 0; i < count && i < maxAttempts; i++) {
      ...
      for (const pos of positions) {
        if (Math.hypot(pos.x - x, pos.y - y) < minDistance) {
          valid = false;
          break;
        }
      }
    ...
    if (this.currentLevel.startsWith('custom_')) {
      ...
      if (customLevel) {
        ...
        this.elements = customLevel.questions[this.currentLang].map((q, i) => ({
          ...
          question: q.text,
          answer: q.name,
          hint: { en: 'Custom level hint', ru: 'Подсказка для пользовательского уровня' }[this.currentLang]
        }));
      } else {
        location.href = 'index.html';
      }
  ...
  createUI() {
    ...
    header.innerHTML = `
      ...
      <p>Coins: <span id="coins">${this.userCoins}</p>
      <p></p>
    `;
